...
const image = require('../assets/facial-treatment.png');
...
const navigation=useNavigation();
  ...
  return(
    ...
    <Text style={styles.topic}>Exfoliation</Text>
...
<View style={styles.buttonContainerList}>
      <TouchableOpacity style={styles.button}>
       <View style={styles.checkboxContainer}>
        <Text style={styles.buttonText}>Dermaplaning</Text>
	...
	<View style={styles.buttonContainerList}>
      <TouchableOpacity style={styles.button}>
       <View style={styles.checkboxContainer}>
        <Text style={styles.buttonText}>VI Peel</Text>
        <CheckBox value={isSelected} onValueChange={setSelection} style={styles.checkbox} />
        </View>
      </TouchableOpacity>
    </View>
