...
const image = require('../assets/massage.png');
...
const navigation=useNavigation();
  ...
  return(
    ...
    <Text style={styles.topic}>Full Body</Text>
    
    
     <View style={styles.buttonContainer}>
      <TouchableOpacity onPress={() => navigation.navigate('Hydrotherapy')} style={styles.button}>
     ...
     <View style={styles.buttonContainerList}>
      <TouchableOpacity style={styles.button}>
       <View style={styles.checkboxContainer}>
        <Text style={styles.buttonText}>Hydrotherapy</Text>
